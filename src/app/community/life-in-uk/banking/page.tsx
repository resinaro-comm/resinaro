// src/app/community/life-in-uk/bank-account/starling/page.tsx
import Link from "next/link";

export const metadata = {
  title: "Open a Starling Account in the UK (2025) — Guide for Migrants",
  description:
    "Step-by-step guide to opening a Starling Bank account in the UK for migrants: verification, FSCS protection, card delivery, proof-of-address and common signup issues (2025).",
  metadataBase: new URL("https://www.resinaro.com"),
  alternates: {
    canonical: "/community/life-in-uk/bank-account/starling",
  },
};

export default function StarlingPage() {
  const pageUrl =
    "https://www.resinaro.com/community/life-in-uk/bank-account/starling";
  ...
  const articleJsonLd = {
    ...
    author: { "@type": "Person", name: "Resinaro" },
    publisher: {
      "@type": "Organization",
      name: "Resinaro",
