    ...
    <main className="bg-[#F9F6F1] text-gray-800 pb-20">
      <div className="container mx-auto max-w-5xl px-6">
        ...
        <figure className="mb-6 rounded-xl overflow-hidden border border-gray-200 shadow-sm">
          <Image
            src="/images/stress-anxiety-toolkit-hero-3840x1280.png"
            alt="Peaceful workspace with mindfulness and stress management tools for migrants dealing with anxiety"
            width={3840}
            height={1280}
            priority
            quality={85}
          ...
          <figcaption className="text-sm text-gray-600 px-4 py-3 bg-white/60">
            Essential stress and anxiety management tools for migrants — rapid techniques for dealing with document stress and relocation anxiety.
          </figcaption>
        </figure>
