      ...
      <div className="container mx-auto max-w-4xl px-6 mt-10">
        ...
        <section className="mt-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li><a href="/privacy-policy" className="underline text-green-900">Resinaro Privacy Policy</a></li>
          </ul>
        </section>
        ...
        <section className="mt-10">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <Link href="/contact" className="inline-flex items-center rounded-lg bg-green-900 text-white px-5 py-3 font-medium shadow hover:bg-green-800">
              Contact us →
            </Link>
          </div>
        </section>
