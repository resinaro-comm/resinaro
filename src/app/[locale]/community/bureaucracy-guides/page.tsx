...
export default function BureaucracyGuides({ params }: { params: { locale: "en" | "it" } }) {
      ...
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="space-y-8 mb-12">
          <div className="bg-white p-6 rounded shadow">
            ...
            <Link href={p(locale, "/community/bureaucracy-guides/passport")} className="text-green-900 underline mt-2 inline-block">Read More</Link>
          </div>
          <div className="bg-white p-6 rounded shadow">
            ...
            <Link href={p(locale, "/community/bureaucracy-guides/aire")} className="text-green-900 underline mt-2 inline-block">Read More</Link>
          </div>
          <div className="bg-white p-6 rounded shadow">
            ...
            <Link href={p(locale, "/community/bureaucracy-guides/cie")} className="text-green-900 underline mt-2 inline-block">Read More</Link>
          </div>
        </div>
