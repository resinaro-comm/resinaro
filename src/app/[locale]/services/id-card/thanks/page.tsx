...
export const metadata = {
  ...
  description: "Thank you for your payment. We’ll review your CIE request and email you next steps shortly.",
};
    ...
    <main className="bg-neutral-50 text-green-900 min-h-screen pb-20 px-4">
      <div className="max-w-4xl mx-auto pt-14">
        <header className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-3">Thank you — ID Card (CIE)</h1>
          <p className="text-lg text-green-800 italic max-w-2xl mx-auto">
            Payment received. We’ll confirm your consulate jurisdiction and send a document checklist. Please be patient while we review your case.
          </p>
        </header>
        ...
        <section className="rounded-xl bg-white border border-gray-200 p-6 shadow-sm space-y-3">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>We match your payment with your form submission via email/reference.</li>
            <li>We review your ID, AIRE status and address proof for the CIE application.</li>
            <li>We send a short plan with booking steps and biometric/photo requirements.</li>
          </ul>
        </section>
