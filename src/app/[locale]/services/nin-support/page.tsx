...
export default function NINSupportPage({ params }: { params: { locale: "en" | "it" } }): React.ReactElement {
  return (
        ...
        <aside className="space-y-6">
          ...
          <div className="bg-green-900 text-white rounded-xl p-5">
            ...
            <div className="flex gap-3">
              <Link href={p(params.locale, "/contact")} className="bg-amber-500 hover:bg-amber-600 text-white font-semibold px-4 py-2 rounded-lg w-full text-center">Contact</Link>
              <Link href={p(params.locale, "/services")} className="border border-white px-4 py-2 rounded-lg w-full text-center">All services</Link>
            </div>
          </div>
