...
export default function GovernancePage({ params }: { params: { locale: "en" | "it" } }) {
      ...
      <div className="container mx-auto px-6 max-w-5xl pt-12">
        ...
        <section id="policies" className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <Link href={p(locale, "/privacy-policy")} className="p-4 border rounded-lg hover:shadow-sm flex items-center justify-between">
              <span>Privacy Policy</span>
              <span className="text-gray-500">View</span>
            </Link>

            <Link href={p(locale, "/terms")} className="p-4 border rounded-lg hover:shadow-sm flex items-center justify-between">
        ...
        <section className="bg-green-900 py-8 px-6 rounded-xl text-center text-white">
          ...
          <div className="flex justify-center gap-3">
            ...
            <Link href={p(locale, "/contact")} className="border-white border px-5 py-2 rounded-md hover:bg-white/10">Contact us</Link>
          </div>
        </section>
      </div>
