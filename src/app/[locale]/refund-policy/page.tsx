...
function t(locale: Locale) {
  const en = {
    ...
    lastUpdated: "Last updated: 18 October 2025",
    tldrTitle: "Quick summary",
    tldrBullets: [
      "Our £35 fee covers the full service. We usually start immediately after payment.",
      "No cash refunds as a commercial policy. For cancellations, we issue a Resinaro credit by default, valid for 12 months and usable on any service.",
    ...
    s3P:
      "As a commercial policy, we do not offer cash refunds for voluntary cancellations. Instead we issue a Resinaro account credit, valid for 12 months, redeemable against any of our services. Credits are not redeemable for cash (except where the law requires a cash refund).",
  ...
  const it = {
    ...
    lastUpdated: "Ultimo aggiornamento: 18 ottobre 2025",
    tldrTitle: "Riassunto veloce",
    tldrBullets: [
      "La tariffa di £35 copre l’intero servizio. Di solito iniziamo subito dopo il pagamento.",
      "Come politica commerciale non offriamo rimborsi in denaro. In caso di annullamento forniamo un credito Resinaro, valido 12 mesi e utilizzabile su qualsiasi servizio.",
    ...
    s3P:
      "Come politica commerciale non offriamo rimborsi in denaro per annullamenti volontari. Invece emettiamo un credito Resinaro, valido 12 mesi, utilizzabile per qualsiasi nostro servizio. I crediti non sono convertibili in denaro (salvo obblighi di legge).",
  ...
  return (
    <main className="bg-[#F9F6F1] text-gray-800 py-16">
      <div className="container mx-auto px-6 max-w-4xl">
        <h1 className="text-4xl font-bold text-green-900 mb-2">{ui.pageTitle}</h1>
        ...
        <div className="bg-white border border-amber-100 p-4 rounded-md shadow-sm mb-8">
          <h2 className="font-semibold text-green-900 mb-2">{ui.tldrTitle}</h2>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-2">
            ...
            {ui.s8AfterEmail}{" "}
            <Link href={p(locale, "/contact")} className="underline text-green-900">
              {ui.s8FormText}
            </Link>{" "}
            {ui.s8Include}
          </p>
        ...
        <section className="mt-6">
          <div className="bg-white border-l-4 border-green-900 p-4 rounded-md">
            <h3 className="font-semibold text-green-900 mb-2">{ui.ctaTitle}</h3>
