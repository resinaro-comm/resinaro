      ...
      <div className="container mx-auto px-6 max-w-3xl pt-12">
        ...
        <section className="mt-10">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm text-center">
            ...
            <div className="flex justify-center gap-3">
              <Link href="/contact" className="inline-flex items-center rounded-lg bg-green-900 text-white px-5 py-2 font-medium shadow hover:bg-green-800">
                Contact us
              </Link>
              <a href="/services" className="inline-flex items-center rounded-lg border border-gray-300 px-5 py-2">
                Explore services
              </a>
            </div>
          </div>
        ...
        <section className="mt-8 text-sm text-gray-600">
          <p>
            ...
            <Link href="/privacy-policy" className="underline text-green-900">Privacy Policy</Link>.
          </p>
        </section>
