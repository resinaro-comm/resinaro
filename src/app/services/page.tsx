...
const services: Service[] = [
  { id: "passport", icon: "🛂", title: "Passport & Consular Services", desc: "Booking, paperwork review and urgent consular support for Italian passports from the UK.", bullets: ["Consulate bookings (London/Manchester/Edinburgh)", "Document pack checks", "Urgent support"], fee: "£40–£60", path: "/services/passport", turnaround: "1–14 days", badge: "Popular" },
