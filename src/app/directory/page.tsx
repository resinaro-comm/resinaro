    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <header className="mb-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-3xl text-sm text-muted-foreground">
          Looking for real Italian flavour—wherever you are? You’re in the right place. Our city guides highlight the{" "}
          <strong>best-reviewed restaurants</strong>, authentic <strong>delis</strong>, and stocked <strong>Italian shops</strong>.
          Updated regularly with community tips and links to menus, maps and contact details.
        </p>
      ...
      <ul className="grid grid-cols-1 gap-6 md:grid-cols-3">
        {cities.map((city) => {
          ...
          return (
            <li key={city.key} className="rounded-2xl border bg-white/70 shadow-sm transition hover:shadow-md">
              ...
              <div className="p-5">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  The best Italian places in {city.label}. Restaurants for nights out, delis for fresh counters, and shops for your pantry.
                </p>

                {/* Category chips */}
                <div className="mt-3 flex flex-wrap gap-2">
                  {["restaurants", "delis", "shops"].map((cat) => {
