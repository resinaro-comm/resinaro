    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <header className="mt-4 mb-6 text-center">
        ...
        <p className="mx-auto mt-3 max-w-3xl text-sm text-muted-foreground">
          New in town or planning a treat? We’ve curated the top Italian places in {city}—from date-night restaurants to
          deli counters and pantry shops. Each pick has steady reviews, real Italian flavour, and reliable service.
          Tap a category to see our top 3 with maps, menus and contact info.
        </p>
        <div className="mt-3 inline-flex items-center gap-2 rounded-full border bg-white/60 px-3 py-1 text-xs">
          ...
          <span className="text-muted-foreground">Updated daily • Community-guided</span>
        </div>
      </header>
      ...
      <section className="mt-12 rounded-2xl border bg-gradient-to-br from-emerald-50 to-white p-6">
        ...
        <p className="mt-1 text-muted-foreground">
          We highlight three per category and offer sponsored placements. Share your details and we’ll be in touch.
        </p>
        <div className="mt-4">
          {process.env.NEXT_PUBLIC_FEATURE_FORM_ENDPOINT ? (
            ...
            <>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Tip: set <code>NEXT_PUBLIC_FEATURE_FORM_ENDPOINT</code> to enable the inline form.
              </p>
            </>
          )}
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        {listing.short && (
          <p className="truncate text-xs text-muted-foreground">{listing.short}</p>
        )}
      </div>
    </Link>
  );
