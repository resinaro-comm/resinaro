...
export default function BenefitsForm() {
  ...
  const [benefitType, setBenefitType] = useState("Universal Credit");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const serviceKey = "benefits-guidance";
      ...
      const r1 = await fetch(GAS_URL, {
        ...
        body: JSON.stringify({
          ...
          files: [],
          data: { benefitType, notes: notes.trim() },
        }),
      });
