...
export default function CieForm() {
    ...
    try {
      ...
      const r1 = await fetch(GAS_URL, {
        ...
        body: JSON.stringify({
          ...
          email: "", // email optional for this form; can be requested later if needed
          telephone: telephone.trim(),
          files: filesPayload,
          data: dataPayload,
        }),
  ...
  <input ref={proofRef} type="file" accept=".pdf,image/png,image/jpeg" onChange={onProofChange} className="mt-1" required />
